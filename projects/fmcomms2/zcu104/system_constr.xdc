...
set_property  -dict {PACKAGE_PIN  F17   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_clk_in_p]           ; ## G06  FMC_LPC_LA00_CC_P
set_property  -dict {PACKAGE_PIN  F16   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_clk_in_n]           ; ## G07  FMC_LPC_LA00_CC_N
set_property  -dict {PACKAGE_PIN  H18   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_frame_in_p]         ; ## D08  FMC_LPC_LA01_CC_P
set_property  -dict {PACKAGE_PIN  H17   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_frame_in_n]         ; ## D09  FMC_LPC_LA01_CC_N
set_property  -dict {PACKAGE_PIN  L20   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_p[0]]       ; ## H07  FMC_LPC_LA02_P
set_property  -dict {PACKAGE_PIN  K20   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_n[0]]       ; ## H08  FMC_LPC_LA02_N
set_property  -dict {PACKAGE_PIN  K19   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_p[1]]       ; ## G09  FMC_LPC_LA03_P
set_property  -dict {PACKAGE_PIN  K18   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_n[1]]       ; ## G10  FMC_LPC_LA03_N
set_property  -dict {PACKAGE_PIN  L17   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_p[2]]       ; ## H10  FMC_LPC_LA04_P
set_property  -dict {PACKAGE_PIN  L16   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_n[2]]       ; ## H11  FMC_LPC_LA04_N
set_property  -dict {PACKAGE_PIN  K17   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_p[3]]       ; ## D11  FMC_LPC_LA05_P
set_property  -dict {PACKAGE_PIN  J17   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_n[3]]       ; ## D12  FMC_LPC_LA05_N
set_property  -dict {PACKAGE_PIN  H19   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_p[4]]       ; ## C10  FMC_LPC_LA06_P
set_property  -dict {PACKAGE_PIN  G19   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_n[4]]       ; ## C11  FMC_LPC_LA06_N
set_property  -dict {PACKAGE_PIN  J16   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_p[5]]       ; ## H13  FMC_LPC_LA07_P
set_property  -dict {PACKAGE_PIN  J15   IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports rx_data_in_n[5]]       ; ## H14  FMC_LPC_LA07_N
